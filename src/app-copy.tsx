  ...
  <div className='max-w-7xl mx-auto px-8 w-full py-20'>
    ...
    >
      ...
      <p className='text-on-surface-variant max-w-xl'>
        Deep semantic understanding turns your prose into frame-perfect scenes,
        automatically synchronized with cinematic timing.
      </p>
    </motion.div>
    ...
    <div className='grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[60vh]'>
      ...
      >
        ...
        <div className='absolute bottom-8 left-8 right-8'>
          ...
          <p className='text-on-surface-variant max-w-md'>
            Every line of dialogue and action description generates a distinct
            visual beat.
          </p>
        </div>
      </motion.div>
      ...
      <div className='md:col-span-4 grid grid-rows-2 gap-6'>
        ...
        >
          <Sparkles
            className='text-primary-container mb-4 group-hover:scale-110 transition-transform'
            size={40}
          />
        ...
        >
          ...
          <Timeline
            className='text-primary-container mb-4 group-hover:rotate-12 transition-transform'
            size={40}
          />
          <h3 className='text-xl font-headline font-bold mb-2'>
            Rhythmic Pacing
          ...
          {[
            {
              ...
              desc: 'Control global illumination and volumetric fog.',
              delay: 0.2,
            },
            {
              icon: Video,
              title: 'Virtual Cinematography',
              desc: 'Define lens focal lengths and complex crane paths.',
              delay: 0.4,
            },
...
const CreativeSuite = () => (
  <div className='max-w-7xl mx-auto px-8 w-full py-20'>
    <div className='text-center mb-20'>
      ...
      >
        Scale your production with enterprise-grade collaboration tools designed
        for global studios.
      </motion.p>
    </div>
    <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
      {[
        {
          icon: Hub,
          title: 'Multi-User Directing',
          desc: 'Collaborate in real-time on renderings.',
          delay: 0.1,
        },
        {
          icon: Code,
          title: 'API Access',
          desc: 'Integrate directly into your production pipeline.',
          delay: 0.2,
        },
        {
          icon: Shield,
          title: 'Ethical AI Guardrails',
          desc: 'Enterprise-grade security and copyright safety.',
          delay: 0.3,
        },
      ].map(({ icon: Icon, title, desc, delay }) => (
        <motion.div
        ...
        >
          ...
          <div className='flex-shrink-0 w-[500px] flex flex-col justify-center'>
            ...
            <p className='text-on-surface-variant'>
              Featured productions made with Induce.
            </p>
          </div>
  ...
  <footer className='bg-[#0e0e0e] w-full py-20 px-12 border-t border-outline-variant/10 relative z-[60]'>
    <div className='grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto'>
      <div className='col-span-1'>
        ...
        <p className='font-body text-sm text-on-surface-variant max-w-xs leading-relaxed'>
          The AI Media Infrastructure. Transforming stories into cinematic
          reality through high-energy neural synthesis.
        </p>
      </div>
      <div>
        <h4 className='font-headline font-bold text-sm text-on-surface mb-6 uppercase tracking-widest'>
          Solutions
        </h4>
        <ul className='space-y-4'>
          <li>
            <a
              className='font-body text-sm text-on-surface-variant hover:text-primary-container transition-colors'
              href='#'
            >
              Script-to-Video
            </a>
    ...
    <div className='max-w-7xl mx-auto mt-20 pt-8 border-t border-outline-variant/10 text-center'>
      <p className='font-body text-sm text-on-surface-variant'>
        © 2024 Induce. The AI Media Infrastructure.
      </p>
    </div>
  </footer>
);
        ...
        <section className='py-40 bg-surface px-8 relative z-[60]'>
          ...
          >
            ...
            <p className='text-on-surface-variant text-lg mb-12 max-w-lg mx-auto'>
              Join the elite rank of AI directors and bring your untold stories
              to life today.
            </p>
